 ...
 */
@Deprecated
public class TensorFlowInferenceInterfaceCopy {

    /**
     * Construct a TensorFlowInferenceInterfaceCopy with provided model path.
     *
     * @param model The filepath to the GraphDef proto representing the model.
     */
    public TensorFlowInferenceInterfaceCopy(String model) throws FileNotFoundException {
    ...
    /**
     * Construct a TensorFlowInferenceInterfaceCopy with provided Graph
     *
     * @param g The Graph to use to construct this interface.
     */
    public TensorFlowInferenceInterfaceCopy(Graph g) {
    ...
    private void addFeed(String inputName, Tensor t) {
        // The string format accepted by TensorFlowInferenceInterfaceCopy is node_name[:output_index].
